...
export const BrandLogo = () => (
  <div className="brand-logo-svg">
    <svg viewBox="0 0 260 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      <text x="60" y="36" fill="#F8FAFC" fontFamily="sans-serif" fontWeight="900" fontSize="26" letterSpacing="2">
        VITA
      </text>

      <circle cx="138" cy="32" r="3.5" fill="#00E676" />

      <text x="61" y="48" fill="#94A3B8" fontFamily="sans-serif" fontWeight="700" fontSize="9" letterSpacing="1.8">
        LEARNING HUB
      </text>
    </svg>
  </div>
